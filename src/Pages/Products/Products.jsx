    ...
    const addProduct = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                Swal.fire({ toast: true, position: "top-start", icon: "error", title: json.message, timer: 3000, showConfirmButton: false });
            }
        } catch (error) {
                                ...
                                {products.length > 0 ? (
                                    products.map((prod, index) => (
                                        <tr key={prod.id}>
                                            ...
                                            <td>{prod.price}</td>
                                            <td>{prod.purchase_items_sum_remaining_stock ?? 0}</td>
                        ...
                        <div className="modal-body">
                            <div className="row g-3">
                                ...
                                <div className="col-6">
                                    ...
                                    <input value={minimumStock} onChange={(e) => setMinimumStock(e.target.value)} type="number" className="form-control" placeholder="الحد الامان" />
                                </div>
                                <div className="col-12">
